...
public class UpdateProfile extends AppCompatActivity {
    ...
    EditText name, surname, phoneNumber, department, grade, status, time, distance, mail, password;
    ImageView profilePhoto;
    Button takePhoto, selectGallery, update;
    */
    ...
    ImageView profilePhoto;
    Button takePhoto, selectFromGallery, update;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        name = (EditText) findViewById(R.id.updateprofile_et_name);
        surname = (EditText) findViewById(R.id.updateprofile_et_surname);
        phone = (EditText) findViewById(R.id.updateprofile_et_phone);
        department = (EditText) findViewById(R.id.updateprofile_et_department);
        grade = (EditText) findViewById(R.id.updateprofile_et_grade);
        email = (EditText) findViewById(R.id.updateprofile_et_mail);
        password = (EditText) findViewById(R.id.updateprofile_et_password);
        password2 = (EditText) findViewById(R.id.updateprofile_et_password2);

        profilePhoto = (ImageView) findViewById(R.id.updateprofile_iv_profilePhoto);

        takePhoto = (Button) findViewById(R.id.updateprofile_bt_takePhoto);
        selectFromGallery = (Button) findViewById(R.id.updateprofile_bt_selectPhoto);
        update = (Button) findViewById(R.id.updateprofile_bt_update);

        radioGroupLooking = (RadioGroup) findViewById(R.id.updateprofile_rg_looking);
        radioGroupTime = (RadioGroup) findViewById(R.id.updateprofile_rg_time);
        radioGroupDistance = (RadioGroup) findViewById(R.id.updateprofile_rg_distance);
        ...
        name = (EditText) findViewById(R.id.updateprofile_et_name);
        surname = (EditText) findViewById(R.id.updateprofile_et_surname);
        phoneNumber = (EditText) findViewById(R.id.updateprofile_et_phone);
        department = (EditText) findViewById(R.id.updateprofile_et_department);
        grade = (EditText) findViewById(R.id.updateprofile_et_grade);
        status = (EditText) findViewById(R.id.updateprofile_et_status);
        time = (EditText) findViewById(R.id.updateprofile_et_time);
        distance = (EditText) findViewById(R.id.updateprofile_et_distance);
        mail = (EditText) findViewById(R.id.updateprofile_et_mail);
        password = (EditText) findViewById(R.id.updateprofile_et_password);

        profilePhoto = (ImageView) findViewById(R.id.updateprofile_iv_profilePhoto);

        takePhoto = (Button) findViewById(R.id.updateprofile_bt_takePhoto);
        selectGallery = (Button)findViewById(R.id.updateprofile_bt_selectPhoto);
        update = (Button) findViewById(R.id.updateprofile_bt_update);
        */
    }
    ...
    public void getData(){
        ...
        mReference.updateChildren(mData)
                .addOnCompleteListener(UpdateProfile.this, new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UpdateProfile.this, "Güncelleme Başarılı", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(getApplicationContext(), Profile.class);
                            startActivity(intent);
                        }
                        else{
                            Toast.makeText(UpdateProfile.this, "Güncelleme Başarısız Oldu!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        mReference.child("Users").child(mUser.getUid()).setValue(mData)
                .addOnCompleteListener(UpdateProfile.this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UpdateProfile.this, "Güncelleme işlemi başarılı!\nGiriş ekranına yönlendiriliyorsunuz...", Toast.LENGTH_SHORT).show();                        }
                        else{
        ...
        mSReference.putFile(photoUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(UpdateProfile.this, "Fotoğraf yüklenemedi!", Toast.LENGTH_SHORT).show();
                    }
                })
